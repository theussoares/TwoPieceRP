    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="wanted" className="w-full">
        <TabsList className="grid w-full grid-cols-3">
          <TabsTrigger value="wanted" className="flex items-center space-x-2">
            <DollarSign className="h-4 w-4" />
            <span>Mais Procurados</span>
          </TabsTrigger>
          <TabsTrigger value="strongest" className="flex items-center space-x-2">
            <Zap className="h-4 w-4" />
            <span>Mais Fortes</span>
          </TabsTrigger>
          <TabsTrigger value="factions" className="flex items-center space-x-2">
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-4">
                        <div className="flex items-center space-x-2">
                          ...
                          <Badge 
                            variant="outline" 
                            className={getRankBadgeColor(character.position)}
                          >
                            #{character.position}
                          </Badge>
                        </div>
                      ...
                      <div className="text-right">
                        ...
                        <div className="grid grid-cols-3 gap-1 mt-2 text-xs">
                          <div className="bg-red-100 rounded px-2 py-1">
                            <span className="text-red-700">🔴 {(character.energies?.stamina?.max || 0).toLocaleString()}</span>
                          </div>
                          <div className="bg-purple-100 rounded px-2 py-1">
                            <span className="text-purple-700">⚫ {(character.energies?.haki?.max || 0).toLocaleString()}</span>
                          </div>
                          <div className="bg-green-100 rounded px-2 py-1">
                            <span className="text-green-700">🟢 {(character.energies?.resistance?.max || 0).toLocaleString()}</span>
                          </div>
                        </div>
                      </div>
                    </div>
